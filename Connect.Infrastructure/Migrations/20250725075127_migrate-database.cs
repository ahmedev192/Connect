        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqueSenderId = table.Column<int>(type: "int", nullable: false),
                    UniqueReceiverId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqueUser1Id = table.Column<int>(type: "int", nullable: false),
                    UniqueUser2Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Friendships",
                columns: new[] { "UniqueUser1Id", "UniqueUser2Id" },
                unique: true);
